import React, { useState, useMemo, useContext, Suspense, lazy } from 'react';
...
// Lazy load for visible chart for performance
            ...
            <div style={{ height: 200 }}>
             <Suspense fallback={<div className="flex justify-center items-center h-full"><Spinner /></div>}>
                <LazyResponsiveContainer width="100%" height="100%">
                    <LazyBarChart data={filteredData.employeeReports} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                        <LazyXAxis dataKey="name" fontSize={10} interval={0} />
                        <LazyYAxis />
                        <LazyTooltip />
                        <LazyLegend />
                        <LazyBar dataKey="totalHours" name="Horas Trabalhadas" fill="#3b82f6" radius={[4, 4, 0, 0]} />
                    </LazyBarChart>
